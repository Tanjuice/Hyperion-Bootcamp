...
if not os.path.exists("T17/tasks.txt"):
    with open("tasks.txt", "w") as default_file:
        pass

# Open tasks.txt if already exists
with open("T17/tasks.txt", 'r') as task_file:
...
if not os.path.exists("T17/user.txt"):
    with open("T17/user.txt", "w") as default_file:
        default_file.write("admin;password")
else:
    # Read in user_data
    with open("T17/user.txt", 'r') as user_file:
...
def reg_user():
    ...
    while True:
        ...
        if new_password == confirm_password:
            ...
            with open("T17/user.txt", "w") as out_file:
...
def add_task():
        ...
        while True:
            ...
            with open("T17/tasks.txt", "w") as task_file:
                task_list_to_write = []
                for t in task_list:
                    str_attrs = [
                        t['username'],
