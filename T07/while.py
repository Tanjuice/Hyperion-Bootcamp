...
# Program will then calculate the average of the numbers entered not incuding '-1'

# Create list of future inputs
total_input = []
# Declare inital input converted to an integer
...
while number > -1:
  ...
  # Summarise and ask for another input
